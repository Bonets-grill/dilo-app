  ...
  return (
    <main className="flex items-center justify-center min-h-dvh px-6">
      <div className="w-full max-w-sm">
        ...
        <button onClick={handleGoogleLogin} className="w-full px-4 py-3 rounded-xl bg-[var(--bg2)] border border-[var(--border)] text-white text-sm hover:bg-[var(--bg3)] transition flex items-center justify-center gap-2">
