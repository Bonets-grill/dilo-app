        ...
        <div className="flex items-center justify-center gap-6">
          ...
          {isVideo && (
            <button type="button"
              ...
              aria-label={isCameraOff ? t("cameraOn") : t("cameraOff")}
              aria-pressed={isCameraOff}
            >
              {isCameraOff ? <VideoOff size={22} aria-hidden="true" /> : <Video size={22} aria-hidden="true" />}
            </button>
          )}
          ...
          <button type="button"
            ...
            aria-label={t("hangUp")}
          >
            <PhoneOff size={26} className="text-white" aria-hidden="true" />
          </button>
        </div>
      </div>
    </div>
